...
MIDDLEWARE = [
    ...
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # 必须启用
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # 如果有自定义静态文件目录
...
SESSION_EXPIRE_AT_BROWSER_CLOSE = False  # 浏览器关闭时不会清除会话
SESSION_SAVE_EVERY_REQUEST = True  # 每次请求刷新会话过期时间
